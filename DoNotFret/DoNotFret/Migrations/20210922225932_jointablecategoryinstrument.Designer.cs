...
namespace DoNotFret.Migrations
{
    ...
    [Migration("20210922225932_jointablecategoryinstrument")]
    partial class jointablecategoryinstrument
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoNotFret.Models.AuthUser", b =>
                {
            ...
            modelBuilder.Entity("DoNotFret.Models.InstrumentCategory", b =>
                {
                    b.Property<int>("InstrumentId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("InstrumentId", "CategoryId");
            ...
            modelBuilder.Entity("DoNotFret.Models.InstrumentCategory", b =>
                {
                    b.HasOne("DoNotFret.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DoNotFret.Models.AuthUser", null)
                        .WithMany()
